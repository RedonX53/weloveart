            ...
            <div className="de-flex">
              <div className="de-flex-col">
                <span onClick={() => window.open("", "_self")}>
                  ...
                  />
                  <span className="copy">
                    &copy; Copyright 2022 - We Love Art
                  </span>
                </span>
              </div>
              <div className="de-flex-col">
                <div className="social-icons">
                  <span
                    onClick={() =>
                      window.open(
                        "https://www.facebook.com/weloveart.experience",
                        "_blank"
                      )
                    }
                  >
                  ...
                  <span
                    onClick={() =>
                      window.open(
                        "https://www.instagram.com/weloveart.experience/",
                        "_blank"
                      )
                    }
                  >
                  ...
                  <span
                    onClick={() =>
                      window.open(
                        "https://www.youtube.com/channel/UCu9c3XpM8bj8IaQPvqsTzcw",
                        "_blank"
                      )
                    }
                  >
                  ...
                  <span
                    onClick={() =>
                      window.open(
                        "https://www.pinterest.com/weloveart_experience/pins/",
                        "_blank"
                      )
                    }
                  >
